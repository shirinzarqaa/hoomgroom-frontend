...
export default function Navbar() {
  ...
  return (
    <nav className="flex top-0 gap-16 px-8 py-4 items-center bg-primary fixed w-full left-0">
            ...
            <div className="justify-between flex w-full">
              <div>
                <ul className="flex gap-4 text-blue-primary">
                  ...
                  <NavLink href="/melihat-rincian-produk" isActive={pathname === "/melihat-rincian-produk"}>
